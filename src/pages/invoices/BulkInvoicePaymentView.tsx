            ...
            <Box display="flex" p="lg" className="justify-between">
                <Table className="table-auto w-full max-w-4xl">
                    ...
                    <Table.Tbody>
                        {/* Invoices Section */}
                        <Table.Tr>
                            <Table.Td colSpan={3} className="text-center p-3 text-md font-bold">
                                Invoices
                            </Table.Td>
                        </Table.Tr>
                        ...
                        <Table.Tr>
                            <Table.Td colSpan={2} className="p-3 font-bold text-sm">
                                Total Invoices Amount
                            </Table.Td>
                            <Table.Td className="p-3 font-bold text-sm text-right">{amountPreview(invoiceAmount)}</Table.Td>
                        </Table.Tr>
                        ...
                        <Table.Tr>
                            ...
                            <Table.Td className="p-3 font-bold text-sm text-right">{amountPreview(customerChequeAmount)}</Table.Td>
                        </Table.Tr>
                        ...
                        <Table.Tr>
                            ...
                            <Table.Td className="p-3 font-bold text-sm text-right">{amountPreview(createdChequeAmount)}</Table.Td>
                        </Table.Tr>
                        ...
                        <Table.Tr>
                            ...
                            <Table.Td className="p-3 font-bold text-sm text-right">{amountPreview(addedCashAmount)}</Table.Td>
                        </Table.Tr>

                        {/* Final Balance Section */}
                        <Table.Tr>
                            <Table.Td className="p-3 font-bold text-sm">Balance</Table.Td>
                            <Table.Td className="p-3"></Table.Td>
                            <Table.Td className="p-3 font-bold text-sm text-right">
                                {amountPreview(
                                    invoiceAmount - (customerChequeAmount + createdChequeAmount + addedCashAmount)
                                )}
                            </Table.Td>
                        </Table.Tr>
                    </Table.Tbody>
